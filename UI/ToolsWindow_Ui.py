...
"}")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 993, 121))
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 976, 131))
        ...
        self.pushButton_3.setGeometry(QtCore.QRect(310, 80, 111, 21))
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QtCore.QRect(0, 0, 993, 121))
        ...
        self.channelsLabel = QtWidgets.QLabel(self.frame2)
        self.channelsLabel.setObjectName("channelsLabel")
        self.verticalLayout_15.addWidget(self.channelsLabel)
        ...
        self.label_11 = QtWidgets.QLabel(self.frame3)
        ...
        self.heightLabel_2 = QtWidgets.QLabel(self.frame4)
        self.heightLabel_2.setObjectName("heightLabel_2")
        self.verticalLayout_21.addWidget(self.heightLabel_2)
        self.channelsLabel_2 = QtWidgets.QLabel(self.frame4)
        self.channelsLabel_2.setObjectName("channelsLabel_2")
        self.verticalLayout_21.addWidget(self.channelsLabel_2)
        self.formatLabel_2 = QtWidgets.QLabel(self.frame4)
        self.formatLabel_2.setObjectName("formatLabel_2")
        self.verticalLayout_21.addWidget(self.formatLabel_2)
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 1116, 549))
    ...
    def retranslateUi(self, ToolsWindow):
        ...
        self.pushButton.setText(_translate("ToolsWindow", "图像融合"))
        self.pushButton_2.setText(_translate("ToolsWindow", "图像粘贴"))
        ...
        self.groupBox_8.setTitle(_translate("ToolsWindow", "画笔模式"))
        ...
        self.patternBox.setItemText(0, _translate("ToolsWindow", "二值化"))
        self.patternBox.setItemText(1, _translate("ToolsWindow", "灰度转换"))
        self.patternBox.setItemText(2, _translate("ToolsWindow", "二值转换"))
        self.patternBox.setItemText(3, _translate("ToolsWindow", "RGB转换"))
        self.patternBox.setItemText(4, _translate("ToolsWindow", "RGBA转换"))
        ...
        self.filterBox.setItemText(1, _translate("ToolsWindow", "普通模糊"))
        ...
        self.sizeEdit.setPlaceholderText(_translate("ToolsWindow", "size"))
        self.rankEdit.setPlaceholderText(_translate("ToolsWindow", "rank"))
        ...
        self.meanEdit.setPlaceholderText(_translate("ToolsWindow", "均值"))
        self.sigmaEdit.setPlaceholderText(_translate("ToolsWindow", "标准差"))
        ...
        self.hideInfoEdit.setPlainText(_translate("ToolsWindow", "HELLO WORLD!"))
        self.fontSizeEdit.setPlaceholderText(_translate("ToolsWindow", "字体大小 10"))
        ...
        self.pushButton_3.setText(_translate("ToolsWindow", "随机生成验证码"))
        ...
        self.label_10.setText(_translate("ToolsWindow", "图片高度"))
        self.label_11.setText(_translate("ToolsWindow", "图片通道"))
        self.label_12.setText(_translate("ToolsWindow", "图片格式"))
        self.depthLabel.setText(_translate("ToolsWindow", "TextLabel"))
        self.heightLabel_2.setText(_translate("ToolsWindow", "TextLabel"))
        self.channelsLabel_2.setText(_translate("ToolsWindow", "TextLabel"))
        self.formatLabel_2.setText(_translate("ToolsWindow", "TextLabel"))
        ...
        self.formatBox.setItemText(1, _translate("ToolsWindow", "png"))
        self.formatBox.setItemText(2, _translate("ToolsWindow", "ppm"))
        self.formatBox.setItemText(3, _translate("ToolsWindow", "gif"))
